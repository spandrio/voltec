...
<title>Crear cuenta — Voltec Ergon</title>
...
.card{background:#fff;border:1px solid var(--line);border-radius:16px;max-width:440px;width:100%;
...
<body>
  <div class="card">
    ...
    <form method="POST" action="/auth/register">
      ...
      <input type="text" id="nombre" name="nombre" placeholder="Ej: Harry Ramírez"
    ...
    <div class="foot">¿Ya tenés cuenta? <a href="/auth/login">Iniciar sesión</a></div>
  </div>
</body>
</html>
